...
public:
    CMainParams() {
        ...
        consensus.nDiffChangeTarget = 150000; // BeyondShield Hard Fork height 150000
...
public:
    CTestNetParams() {
        ...
        consensus.nDiffChangeTarget = 100000; // BeyondShield Hard Fork height 100000
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1199145601; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1230767999; // December 31, 2008
...
public:
    CRegTestParams() {
        ...
        consensus.nDiffChangeTarget = 2500; // BeyondShield Hard Fork height 2500
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
